const places = [
  ...
  { id:35, type:'sight',  emoji:'🏛', name:'Golden Gate (Zoloti Vorota)',          cuisine:'Historic Gate',             uah:'~100–150', note:'11th-century fortress gate built by Yaroslav the Wise in 1037 — the main triumphal entrance to ancient Kyiv. The structure you see is a 1982 Soviet reconstruction but chunks of the original walls survive inside. Climb the 29 m tower for views. Bronze cat statue and monument to Yaroslav the Wise outside. Right at Zoloti Vorota metro station.', lat:50.4503, lng:30.5136, walk:'5 min · 0.4 km', walkKm:0.4, headerGrad:'linear-gradient(135deg,#BF8C00,#FFD54F)', hours:'Tue–Sun 10:00–18:00 (Wed till 17:00, closed Mon)', url:'https://guide.kyivcity.gov.ua/en/places/zoloti-vorota' },
  { id:36, type:'sight',  emoji:'🏛', name:"St. Andrew's Church",                  cuisine:'Baroque Church',            uah:'~80',      note:'Baroque masterpiece designed by Rastrelli (the same architect as the Winter Palace in St. Petersburg), completed 1754. Perched dramatically at the top of Andriyivskyy Descent. Five-domed silhouette visible from Podil and the river. Interior recently restored and open again.', lat:50.4590, lng:30.5179, walk:'12 min · 0.9 km', walkKm:0.9, headerGrad:'linear-gradient(135deg,#0D47A1,#42A5F5)', hours:'10:00–18:00', url:'https://en.wikipedia.org/wiki/St_Andrew%27s_Church,_Kyiv' },
  { id:37, type:'sight',  emoji:'🏛', name:'House with Chimaeras',                 cuisine:'Art Nouveau Mansion',       uah:'Free',     note:'1902 Art Nouveau mansion by architect Horodetsky, nicknamed the Gaudí of Kyiv. Facade covered in concrete sculptures of rhinos, elephants, sea monsters and hunting trophies. Appears 3-storey from front, 6-storey from rear due to the steep slope. One of the most photogenic buildings in the city. Area is patrolled due to proximity to the Presidential Administration — go for photos, don\'t expect to enter.', lat:50.4430, lng:30.5240, walk:'16 min · 1.3 km', walkKm:1.3, headerGrad:'linear-gradient(135deg,#004D40,#26A69A)', hours:'Exterior 24h (interior rarely open)', url:'https://en.wikipedia.org/wiki/House_with_Chimaeras' },
  { id:38, type:'sight',  emoji:'🏛', name:'Holodomor Memorial & Museum',           cuisine:'Genocide Memorial',         uah:'~30',      note:'National museum dedicated to the 1932–33 Soviet-engineered famine that killed an estimated 7–10 million Ukrainians. Haunting grounds: 24 millstones representing 24,000 daily deaths, the skeletal sculpture of a young girl clutching wheat, and the 30 m Candle of Memory tower whose bells chime as you approach. Underground Hall of Memory lists 14,000 affected villages. Adjacent to Pechersk Lavra — pair them on the same visit.', lat:50.4320, lng:30.5583, walk:'55 min · 4.4 km', walkKm:4.4, headerGrad:'linear-gradient(135deg,#37474F,#78909C)', hours:'10:00–18:00 (closed 2nd Tue/month)', url:'https://holodomormuseum.org.ua/en/' },
  { id:39, type:'sight',  emoji:'🏛', name:'Ukrainian National Chernobyl Museum',   cuisine:'Disaster Museum',           uah:'~130',     note:'Housed in a former 1930s fire station in Podil. Extensive collection of artefacts, photos, protective gear and personal testimonies from the 1986 disaster. Soviet-era vehicles parked outside. Audio guide available in English (worth it — most labels are Ukrainian only). The next best thing to visiting Chernobyl itself, and a good primer if you\'re doing the tour. Dim, solemn atmosphere.', lat:50.4637, lng:30.5168, walk:'18 min · 1.5 km', walkKm:1.5, headerGrad:'linear-gradient(135deg,#E65100,#FFB74D)', hours:'Tue–Sat 10:00–18:00 (closed Sun–Mon)', url:'https://en.wikipedia.org/wiki/Ukrainian_National_Chernobyl_Museum' },
  { id:40, type:'sight',  emoji:'🚃', name:'Kyiv Funicular',                        cuisine:'Cable Railway',             uah:'~8',       note:'Built in 1905, this 238 m cable railway connects the upper city (near St. Michael\'s Monastery) down to Podil in 3 minutes. One of the oldest funiculars in Eastern Europe, recently renovated with WiFi in the cars. Tiny fare, great views of the Dnieper. The natural end-point of a walk down Andriyivskyy Descent — ride up or down, then explore both neighbourhoods.', lat:50.4574, lng:30.5221, walk:'10 min · 0.8 km', walkKm:0.8, headerGrad:'linear-gradient(135deg,#00695C,#4DB6AC)', hours:'07:00–22:00', url:'https://en.wikipedia.org/wiki/Kyiv_Funicular' }
];
